...
# ============================================================
# CampWatchMe - alignment_drop_all_parameters_trial.sh
# Testing all loosened parameters together:
#   -z 400,200          (was 600,200)
#   -s 40               (was default 80)
#   --min-chain-score 20 (was default 40)
# All other flags identical to alignment_repeat_req_flags.sh
# Output: minimap-diff-parameters-trial/drop-all
# ============================================================
...
mkdir -p $PROJECT/minimap-diff-parameters-trial/drop-all
...
echo "BAM files saved in: $PROJECT/minimap-diff-parameters-trial/drop-all-parameters"
