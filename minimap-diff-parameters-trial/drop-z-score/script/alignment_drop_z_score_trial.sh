...
# ============================================================
# CampWatchMe - alignment_drop_z_score_trial.sh
# Testing default Z score 400,200 vs original 600,200
# All other flags identical to alignment_repeat_req_flags.sh
# Output: minimap-diff-parameters-trial/drop-z-score/
# ============================================================
...
mkdir -p $PROJECT/minimap-diff-parameters-trial/drop-z-score
...
echo "BAM files saved in: $PROJECT/minimap-diff-parameters-trial/drop-z-score"
