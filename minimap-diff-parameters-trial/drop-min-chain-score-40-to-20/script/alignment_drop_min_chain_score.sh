...
# ============================================================
# CampWatchMe - alignment_drop_min_chain_score_trial.sh
# Testing --min-chain-score 20 (was default 40) + -z 400,200 (was 600,200)
# All other flags identical to alignment_repeat_req_flags.sh
# Output: minimap-diff-parameters-trial/drop-min-chain-score-40-to-20/
# ============================================================
...
mkdir -p $PROJECT/minimap-diff-parameters-trial/drop-min-chain-score-40-to-20
...
echo "BAM files saved in: $PROJECT/minimap-diff-parameters-trial/drop-min-chain-score-40-to-20"
